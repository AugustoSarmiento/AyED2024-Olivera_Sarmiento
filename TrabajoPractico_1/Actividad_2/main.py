...
class Test_LDE(unittest.TestCase):
    """Test de la clase ListaDoblementeEnlazada"""
    ...
    def test_iteracion(self):
        ...
        En cada iteración debe devolver el data siguiente, no el nodo.
        """

        nodo = self.lde_2.cabeza
        for data in self.lde_2:
            self.assertEqual(nodo.data, data,
                             "Los datas arrojados en el for no coinciden con los datas "
    ...
    def test_agregar_al_inicio(self):
        ...
        self.assertEqual(nodo_copia.data, valorNuevo,
        ...
        while nodo_original.siguiente is not None:
            self.assertEqual(nodo_original.data, nodo_copia.data,
                             "Se modificaron los datas de la lista luego de agregar el nuevo elemento")
        ...
        self.assertEqual(lde1_copia.cabeza.data, valorNuevo,
    ...
    def test_agregar_al_final(self):
        ...
        while nodo_original.siguiente is not None:
            self.assertEqual(nodo_original.data, nodo_copia.data,
                             "Se modificaron los datas de la lista luego de anexar el nuevo elemento")
            nodo_original = nodo_original.siguiente
            nodo_copia = nodo_copia.siguiente
    ...
    def test_insertar_extremos(self):
        ...
        self.assertEqual(self.lde_2.cabeza.data, 120)
    ...
    def test_extraer_interior(self):
        ...
        while nodo_original is not None:
            if contador_pos == posicion:
                self.assertEqual(nodo_original.data, item,
    ...
    def test_copiar(self):
        ...
        while nodo_original or nodo_copia:
            ...
            self.assertEqual(nodo_original.data, nodo_copia.data,
                             "Los datas de la lista copiada no son iguales a los de la lista original")
    ...
    def test_invertir(self):
        ...
        for _ in range(self.n_elementos):
            self.assertEqual(nodo_invertido.data, nodo_original.data)
    ...
    def recorrer_lista(self, lista):
        ...
        while nodo is not None:
            counter -= 1
            self.assertEqual(elementos[counter], nodo.data,
    ...
    def test_metodo_concatenar(self):
        ...
        while nodo_original is not None:
            self.assertEqual(nodo_original.data, nodo_concat.data,
